...
\begin{document}
	...
	The inner product naturally defines a norm and an associated distance on the vector space as follows. In the following we will restrict our analysis to the case of $\mathbb{F} = \mathbb{R}$.
