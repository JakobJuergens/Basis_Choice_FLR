...
\begin{document}
	...
	\begin{frame}{Square Integrable Function}
		...
		the function $f$ is called \textbf{Square Integrable Function}\\
	...
	\begin{frame}{Estimation via Basis Representation}
		...
		\begin{itemize}
			\item This allows us to write each observation in the data set as $\{y_i, Z_{i,1}, Z_{i,2}, \dots\}$
			\item Truncating the functional basis yields an approximation $\{y_i, Z_{i,1}, Z_{i,2}, \dots, Z_{i,L}\}$
		\end{itemize}
	...
	\begin{frame}{Functional Principal Component Analysis}
		{\color{red} Rephrase this!} This idea can be extended to functional regressors in the form of \textbf{Functional Principal Component Analysis} (FPCA).
		\vspace{0.2cm}
