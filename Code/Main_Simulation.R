...
for (i in 100:104) {
  ...
  saveRDS(test_fpcr2, file = paste0("Results/Partial/pca_fourier_nharm2_sim_partial/rep500_n_obs200_seed", i, ".RDS"))
}
################################################################
...
for (i in 100:104) {
  ...
  saveRDS(test_bspline_function_NIR,
...
for (i in 100:104) {
  ...
  saveRDS(test_fourier_function_NIR,
