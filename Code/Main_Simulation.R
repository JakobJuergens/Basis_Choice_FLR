...
for (i in 100:109) {
  ...
  saveRDS(
    ...
    file = paste0("Results/Paper/Partial/bspline_sim_partial/rep500_n_obs200_seed", i, ".RDS")
  )
}
...
for (i in 100:109) {
  ...
  saveRDS(
    ...
    file = paste0("Results/Paper/Partial/fourier_sim_partial/rep500_n_obs200_seed", i, ".RDS")
  )
}
...
for (j in 2:4) {
  for (i in 100:109) {
    ...
    saveRDS(
      object = test_fpcr,
      file = paste0("Results/Paper/Partial/pca_bspline_nharm", j, "_sim_partial/rep500_n_obs200_seed", i, ".RDS")
    )
  }
}
...
for (j in 2:4) {
  for (i in 100:109) {
    ...
    saveRDS(
      object = test_fpcr2,
      file = paste0("Results/Paper/Partial/pca_fourier_nharm", j, "_sim_partial/rep500_n_obs200_seed", i, ".RDS")
    )
  }
}
################################################################
...
for (i in 100:109) {
  ...
  saveRDS(
    ...
    file = paste0("Results/Paper/Partial/bspline_NIR_partial/NIRrep500_n_obs60_seed", i, ".RDS")
  )
}
...
for (i in 100:109) {
  ...
  saveRDS(
    ...
    file = paste0("Results/Paper/Partial/fourier_NIR_partial/NIR_fourier_rep500_n_obs60_seed", i, ".RDS")
  )
}
...
for (j in 4:4) {
  for (i in 100:109) {
    ...
    saveRDS(
      ...
      file = paste0("Results/Paper/Partial/pca_bspline_nharm", j, "_NIR_partial/NIRrep500_n_obs60_seed", i, ".RDS")
    )
  }
}
...
for (j in 2:4) {
  for (i in 100:109) {
    ...
    saveRDS(
      ...
      file = paste0("Results/Paper/Partial/pca_fourier_nharm", j, "_NIR_partial/NIRrep500_n_obs60_seed", i, ".RDS")
    )
  }
}
