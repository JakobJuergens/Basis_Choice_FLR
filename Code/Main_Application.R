...
for (j in 2:4) {
  ...
  saveRDS(object = fourier_fpcr_appl, file = paste0("Results/Paper/Application/fourier_fpcr_nharm", j, "_appl_additional.RDS"))
  write_csv(x = fourier_fpcr_appl, file = paste0("Results/Paper/Application/fourier_fpcr_nharm", j, "_appl_additional.csv"))
}
...
for (j in 2:4) {
  ...
  saveRDS(object = monomial_fpcr_appl, file = paste0("Results/Paper/Application/monomial_fpcr_nharm", j, "_appl_additional.RDS"))
  write_csv(x = monomial_fpcr_appl, file = paste0("Results/Paper/Application/monomial_fpcr_nharm", j, "_appl_additional.csv"))
}
