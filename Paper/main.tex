...
%		\end{itemize}
	...
	where $\delta(t)$ is the truncation error and $L \leq \max\limits_{j \in \mathcal{I}}(j)$ for all $L \in \mathcal{I}$. The number $L$ can be chosen subjectively, but also through applying a data-driven method such as Cross-Validation. The influence of this truncation on the prediction accuracy of different estimates is the subject of the simulation study. {\color{red} Add text for figure}
