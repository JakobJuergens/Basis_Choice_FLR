...
\begin{document}
	...
	{\color{red} No shift parameter in implementation in fda.} The Monomial basis are trivially decompositions of every polynomial function. 	
