...
The polynomial of the form 
	...
	Using the same basis and the same truncation parameter $L$ leads to the following simplifications of Equation \ref{FPCA_basis_expansion}.
	...
	For notational purposes in this paper we define the following convention:
