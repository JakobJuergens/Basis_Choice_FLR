...
%		\end{itemize}
	...
	As the B-spline basis does not have infinitely many elements as the full Monomial or Fourier bases have, it is slightly misleading to speak of truncating the B-spline basis at a truncation parameter $L$ in later parts of this paper. For the sake of keeping the notation reasonably concise, we will still keep this notation. However, by convention, this shall mean using a B-spline basis consisting of $L$ functions from this point on.
